# Top priority features and bugs
...
x Disable wrong answers and let them try a different answer.
...
x Add some kind of animation on selecting the answers.

x Possibly hide the log and only display on request and maybe only
